...
const JobForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      addNotification(
        error instanceof Error ? error.message : 'Failed to save job application',
        'error'
      );
    } finally {
      setLoading(false);
    ...
    <div className="max-w-2xl mx-auto">
      <div className="mb-6">
        ...
        <p className="text-gray-600 mt-1">
          {isEdit ? 'Update the details of your job application' : 'Track a new job opportunity'}
        </p>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <input
              ...
              id="appliedDate"
              name="appliedDate"
              className={`input-field ${errors.appliedDate ? 'border-red-500 focus:ring-red-500' : ''}`}
